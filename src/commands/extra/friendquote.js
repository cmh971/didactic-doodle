...
export const data = new SlashCommandBuilder().setName('friendquote').setDescription('A random friend quote');
export async function execute(interaction) {
  await interaction.reply('💬 **friend** quote: friend ' + pick(QUOTES));
}
