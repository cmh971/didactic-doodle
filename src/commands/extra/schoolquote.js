...
export const data = new SlashCommandBuilder().setName('schoolquote').setDescription('A random school quote');
export async function execute(interaction) {
  await interaction.reply('💬 **school** quote: school ' + pick(QUOTES));
}
