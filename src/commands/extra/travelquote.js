...
export const data = new SlashCommandBuilder().setName('travelquote').setDescription('A random travel quote');
export async function execute(interaction) {
  await interaction.reply('💬 **travel** quote: travel ' + pick(QUOTES));
}
