...
export const data = new SlashCommandBuilder().setName('futurequote').setDescription('A random future quote');
export async function execute(interaction) {
  await interaction.reply('💬 **future** quote: future ' + pick(QUOTES));
}
