...
export const data = new SlashCommandBuilder()
  .setName('snakecase')
  .setDescription("snake_case your text")
...
export async function execute(interaction) {
  ...
  let out;
  try { out = (function (t) { return t.trim().toLowerCase().replace(/[^a-z0-9]+/g,'_').replace(/^_+|_+$/g,''); })(t); } catch { out = '⚠️ Could not transform that.'; }
